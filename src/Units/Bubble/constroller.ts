...
export const bubbleConrtoller: UnitController<UnitName.Bubble> = (index, diff, unit, store) => {
    const rotation = getAngleRelativeToOrigin(unit) + 180;
    const nextPosition = getPointRelativeToOriginByAngleAndDistance(diff / 400, rotation);
